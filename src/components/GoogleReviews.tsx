...
import { Star, CheckCircle2, ExternalLink, ThumbsUp, MessageSquareQuote, ShieldCheck } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16">
          <div className="space-y-4 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-white border border-slate-200 rounded-full shadow-xs">
              ...
              <span className="text-[11px] font-bold text-navy-900 tracking-wide">Google Business Page Reviews</span>
              <span className="text-yellow-500 font-bold text-[11px]">★ 4.9 / 5.0</span>
            </div>
            ...
            <p className="text-navy-500 font-sans text-sm leading-relaxed">
              Real feedback from parents at Rocking Kids Academy. See how our Abacus, Phonics, English, and Handwriting programs empower students on Ponmar Main Road.
            </p>
          </div>
          ...
          <div className="bg-white p-6 border border-slate-200 rounded-xl shadow-md flex items-center gap-6 shrink-0">
            <div className="text-center border-r border-slate-100 pr-6">
              <div className="text-4xl font-black text-navy-900 leading-none">4.9</div>
              <div className="flex text-yellow-400 my-1 justify-center">
                {[...Array(5)].map((_, i) => (
                  <Star key={i} size={14} className="fill-yellow-400" />
                ))}
              </div>
              <p className="text-[10px] font-bold uppercase tracking-widest text-navy-400">183 Google Reviews</p>
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                Read all 183 reviews on Google Maps <ExternalLink size={12} />
              </a>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                <div className="space-y-4">
                  {/* Top Bar with Avatar, Name, Verified Badge */}
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <div className={`w-10 h-10 ${review.avatarColor} text-white font-bold text-sm flex items-center justify-center rounded-full shadow-xs uppercase`}>
